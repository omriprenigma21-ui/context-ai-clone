...
// Import LinearArtifactViewer for project management
const LinearArtifactViewer = ({ data, onClose }: {
  data: any;
  onClose: () => void;
}) => {
  return (
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center py-12">
            <Kanban className="w-16 h-16 mx-auto text-gray-400 mb-4" />
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Project Management Artifact</h3>
            <p className="text-gray-600 mb-6">
              Linear-style project management with issues, priorities, and team collaboration
            </p>
            <div className="bg-gray-50 rounded-lg p-6">
              <h4 className="font-medium text-gray-900 mb-3">Sample Project: AI Platform Development</h4>
              <div className="space-y-3 text-left">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-orange-500 rounded-sm"></div>
                  <span className="text-sm">AI-001: Implement Neural Network Architecture (High Priority)</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-gray-400 rounded-full"></div>
                  <span className="text-sm">AI-002: User Authentication & Authorization (Medium Priority)</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-gray-400 rounded-full"></div>
                  <span className="text-sm">AI-003: API Gateway Configuration (Low Priority)</span>
                </div>
              </div>
              <p className="text-xs text-gray-500 mt-4">
                Full LinearArtifactViewer with command palette (⌘K), custom fields, and templates available
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  <DropdownMenuItem onClick={() => setShowProjectViewer(true)}>
            ...
            issues: [
              {
                ...
                status: "in-progress",
                dueDate: "Jun 24",
                assignee: { name: "fouad.omri", initials: "FO" }
              },
              {
                id: "AI-002",
