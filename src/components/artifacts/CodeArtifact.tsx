...
export const CodeArtifact = ({ artifact, size = "large", onClick }: CodeArtifactProps) => {
  return (
    <Card
      className={`${
        size === "small" ? "p-3" : "p-4"
    ...
    >
      <div className="flex items-start space-x-3">
        ...
        } bg-yellow-50 rounded-lg flex items-center justify-center flex-shrink-0`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          {size === "large" && (
            <div className="mt-2 text-xs text-gray-600">
              JavaScript integration script for data processing
            </div>
          )}
        </div>
      </div>
