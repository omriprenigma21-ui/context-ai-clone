  ...
  const initializeUniver = async () => {
    try {
      ...
      if (artifactType === 'spreadsheet') {
        ...
        const workbook = univer.createUnit(UniverInstanceType.UNIVER_SHEET, workbookData as any);
        ...
        const doc = univer.createUnit(UniverInstanceType.UNIVER_DOC, docData as any);
