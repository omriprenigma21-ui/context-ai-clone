...
export const DocumentArtifact = ({ artifact, size = "large", onClick }: DocumentArtifactProps) => {
  return (
    <Card
      className={`${
        size === "small" ? "p-3" : "p-4"
    ...
    >
      <div className="flex items-start space-x-3">
        ...
        } bg-blue-50 rounded-lg flex items-center justify-center flex-shrink-0`}>
        ...
        <div className="flex-1 min-w-0">
          ...
          {size === "large" && (
            <div className="mt-2 text-xs text-gray-600">
              Revenue analysis report with comprehensive financial insights
            </div>
          )}
        </div>
      </div>
